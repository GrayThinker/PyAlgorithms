...
def main(low=10, high=100, step=10, reps=1, min_num=0, max_num=10000, test=False):
    ...
    for num in number_of_elements:
        ...
        if test:
            ...
            if not test_sort(heap_sort, numbers): raise ValueError("Heap sort error")
        ...
        heap_times.append(time_sort('heap_sort', numbers, reps))
    ...
    plt.plot(number_of_elements, heap_times, color='#000FF1', label='Heap sort')
